...
import * as fixedClient from '../services/api-client/fixed-client'
...
export const getServerSideProps: GetServerSideProps = async ({req, res}) => {
  ...
  const pendingMessages = await fixedClient.chat(`hello from ssr to ${userId}`)
  return {
    props: {
      pendingMessages
    }
